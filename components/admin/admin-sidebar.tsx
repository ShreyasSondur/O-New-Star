...
import { Hotel, LayoutDashboard, Building2, Ban, LogOut, ShieldCheck } from "lucide-react"
    ...
    <aside className="w-64 bg-white border-r flex flex-col">
      ...
      <div className="p-6 border-b">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-900">O New Star Hotel</h2>
      ...
      <div className="p-4 border-t">
        <button
          onClick={onLogout}
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors text-left cursor-pointer"
        >
